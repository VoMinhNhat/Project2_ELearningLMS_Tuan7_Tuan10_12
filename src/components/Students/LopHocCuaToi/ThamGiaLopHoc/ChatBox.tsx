...
import { HiOutlinePaperAirplane } from 'react-icons/hi';
 ...
 export const ChatBox = () =>{
    ...
    const [chatBoxOn, setChatBoxOn] = useState('chatBox');
    const [chatBoxOff, setChatBoxOff] = useState('chatBox-Off-2');

    const OpenChatBox = () =>{
        setChatBoxOn('chatBox');
        setChatBoxOff('chatBox-Off-2');
    }

    const CloseChatBox = () =>{
        setChatBoxOn('chatBox-2');
        setChatBoxOff('chatBox-Off');
    }

    return (
        <>
            {/* Chat box mở */}
            <div className={chatBoxOn}>
                ...
                <div className="openChatBox">
                    ...
                    <AiOutlineMinus style={{ color: '#FF7506', fontSize: '25px', marginTop: '13px', marginLeft: '80px' }} onClick={CloseChatBox}/>
                </div>
            ...
            {/* Chat box đóng */}
            <div className={chatBoxOff} onClick={OpenChatBox} >
                <BsChevronDown style={{color: '#FF7506', fontSize: '25px', marginTop: '13px', marginRight: '5px'}}/>
                    <div style={{fontSize: '16px', width :'100px', height: '30px', fontWeight: '700', marginTop: '12px'}}>
                        Chat với lớp
                    </div>
